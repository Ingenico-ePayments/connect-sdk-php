<?php
class GCS_token_definitions_TokenSepaDirectDebit extends GCS_token_definitions_AbstractToken
{
    /**
    ...
    /**
     * @var GCS_token_definitions_MandateSepaDirectDebit
     */
    public $mandate = null;
    ...
    public function fromObject($object)
    {
        ...
        if (property_exists($object, 'mandate')) {
            ...
            $value = new GCS_token_definitions_MandateSepaDirectDebit();
