 ...
 * @group obfuscation
 */
class GCS_HttpObfuscatorTest extends PHPUnit_Framework_TestCase
{
    /**
     ...
     */
    public function testRawObfuscatedResponse(GCS_ConnectionResponse $response, $expectedRawObfuscatedResponse)
    {
        $httpObfuscator = new GCS_HttpObfuscator();
        $this->assertEquals(
    ...
    public function rawObfuscatedResponseProvider()
    {
        return array(
            array(
                new GCS_DefaultConnectionResponse(0, array(), ''),
                ""
            ),
            array(
                new GCS_DefaultConnectionResponse(
                    200,
