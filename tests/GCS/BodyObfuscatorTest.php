 ...
 * @group obfuscation
 */
class GCS_BodyObfuscatorTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $bodyObfuscator = new GCS_BodyObfuscator();
        $this->assertEquals(
            $obfuscatedJsonBody,
            $bodyObfuscator->obfuscateBody(GCS_BodyObfuscator::MIME_APPLICATION_JSON, $jsonBody)
        );
    }
    ...
    {
        return array(
            array(GCS_BodyObfuscator::MIME_APPLICATION_JSON, 'foo'),
            array(GCS_BodyObfuscator::MIME_APPLICATION_JSON, '{'),
            array('text/html', ''),
            array('text/html', 'foo'),
            array('text/html', '{'),
